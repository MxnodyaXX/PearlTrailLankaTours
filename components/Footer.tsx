...
export default function Footer() {
  return (
    <footer className="bg-[#020617] text-white border-t border-white/[.06] pt-20 pb-8 px-5">
      <div className="w-[min(1120px,100%)] mx-auto">

        {/* Top CTA row */}
        <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6 mb-16 pb-16 border-b border-white/[.06]">
          <h2
            className="font-black text-white leading-[.95] max-w-2xl"
            style={{ fontSize: "clamp(28px,5vw,68px)", letterSpacing: "-0.04em" }}
          >
          ...
          <div className="flex flex-wrap gap-3 shrink-0">
            <Link
              href="/contact"
              className="bg-gold hover:bg-gold-deep text-[#0f172a] font-black text-sm px-6 py-3.5 rounded-full transition-all"
            >
              Request a Quote
            </Link>
            <a
              ...
              className="bg-emerald-500 hover:bg-emerald-600 text-white font-black text-sm px-6 py-3.5 rounded-full transition-all"
            >
              WhatsApp
            </a>
          </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-16">
            ...
            <div className="flex gap-2">
              {socials.map((s) => (
                <a
                  ...
                  rel="noopener noreferrer"
                  aria-label={s.label}
                  className="w-9 h-9 bg-white/[.06] hover:bg-gold rounded-full flex items-center justify-center text-[10px] font-black text-white hover:text-[#0f172a] transition-all"
                >
          ...
          <div>
            <p className="text-[10px] font-black uppercase tracking-[.18em] text-white/30 mb-4">Quick Links</p>
          ...
          <div>
            <p className="text-[10px] font-black uppercase tracking-[.18em] text-white/30 mb-4">Popular Tours</p>
            <ul className="flex flex-col gap-2">
              {tours.map((l) => (
                <li key={l.href}>
                  <Link href={l.href} className="text-white/55 hover:text-gold text-[13px] transition-colors">
          ...
          <div>
            <p className="text-[10px] font-black uppercase tracking-[.18em] text-white/30 mb-4">Contact Us</p>
        ...
        <div
          ...
          style={{ fontSize: "clamp(64px,16vw,200px)", letterSpacing: "-0.06em", marginBottom: "-0.15em" }}
        >
          Pearl<span className="text-gold/20">Trail</span>
        </div>

        {/* Bottom bar */}
        <div className="border-t border-white/[.05] pt-6 flex flex-col md:flex-row justify-between gap-3 text-[12px] text-white/25">
